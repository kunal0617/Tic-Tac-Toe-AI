...
class App extends React.Component{
  ...
  themeSwitch = () => {
    ...
    if(boardDOM) {
      if(this.state.theme === "Light"){
        ...
        for( let i of document.getElementsByClassName("square")) {
  ...
  render() {
    if(this.state.showBoard) {
      return (
        <>
          <Button className="theme-switch" onClick={this.themeSwitch}>
            Apply {this.state.theme === "Light" ? "Dark" : "Light"} Theme
          </Button>
    ...
    <Modal show={this.state.isModalVisible}>
      ...
      <Modal.Body>
        <p>Configure before playing <br/></p>
      </Modal.Body>
    ...
    <div id="settings-gui">
      ...
      <div className="setting-info">Your Pick: {this.state.user}</div>
